...
Status: selective bootstrap provenance. The existing design at `/root/dsh-right-sidebar/PROPOSAL.md` is evidence and does not override user intent or current state.
