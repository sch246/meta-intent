...
- `/root/dsh-right-sidebar` and `/root/deepseek-harness` are bootstrap reality resources for that example, not portable requirements of the protocol. The official reproducible Harness baseline is remote commit `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e`; local `b642a106` is a five-commit-ahead skill-enablement assembly context rather than remote authority.
