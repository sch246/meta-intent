...
- Classify before changing semantic artifacts. Implementation-only repair does not require a new LOG, STATE revision or LOCK; each artifact added must have its own continuing semantic, authority or realization purpose.
